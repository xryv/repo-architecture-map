...
def main():
    ...
    ap.add_argument("--format", choices=["md","mermaid"], default="md",
                    help="Output wrapper: Markdown+Mermaid (md) or raw Mermaid (mermaid).")
    ap.add_argument("--theme", choices=["auto","dark","light","plain"], default="auto",
                    help="Diagram theme presets (auto picks dark/light from env).")
    ap.add_argument("--style", choices=["fancy","plain"], default="fancy",
                    help="Fancy adds classDefs, legend, and visual cues.")
    ap.add_argument("--legend", action="store_true",
                    help="Force include legend (fancy style implies legend by default).")
    ap.add_argument("--dry-run", action="store_true",
                    help="Print to stdout regardless of --out (handy for previews).")
    ...
    mermaid = core.build_mermaid(
        graph,
        theme=args.theme,
        style=args.style,
        include_legend=(args.legend or args.style=="fancy")
    )
